...
*/
const BotName = '👾DIMAS👾'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/Official.kingdoom'; // Nama Instagramlu cok
const whatsapplu = 'Wa.me/6282136701465'; // Nomor whatsapplu cok
const kapanbotaktif = 'Tergantung jaringan'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/BOR1kFRJq4uKPmKL9lp6R7'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/FrCFBjyhACHKpyqMGkdwIm'; // OFFICIAL GRUP LU 2
const grupch3 = 'https://chat.whatsapp.com/DxCbeJEL0XtAenYYCSuSyB'; // OFFICIAL GRUP LU 3
//
